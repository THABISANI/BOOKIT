...
public class LandingPage extends AppCompatActivity implements View.OnClickListener{
    ...
    public void initializeDataBase()
    {
        ...
        if(!string.equalsIgnoreCase("logged"))
        {
            ...
            /*db.insertData("DN76875", "ALGORITHMS","ROBERT SEGWICK","3580034","Robert Segwick's book for algorithms is targeted for people who are familiaridez with coding at an advanced stage","3",""+R.drawable.algorithms,"Fourth addition", "NA", "NA");
            ...
            db.insertData("GB76875", "MATHEMATICS","ROBERT SEGWICK","3580034","Robert Segwick's book for algorithms is targeted for people who are familiarized with coding at an advanced stage","2",""+R.drawable.mathbook,"twelveth addition", "NA", "NA");
            db.insertData("DCX6875", "MATHEMATICS","JAMES BOND","3580034","Calculus for actors is a book written for people who are slow learners and need proper explanations and exapmles","1",""+R.drawable.maths1,"second addition", "NA", "NA");
